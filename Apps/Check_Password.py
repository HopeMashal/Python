def checkPassword(password):
  if len(password)>=8 and len(password)<20:
    ...
    if (hasUpper and hasLower and hasNumber and hasSymbol):
      ...
      print("The password is invalid!! Please add upper case")
    elif(not hasUpper and not hasLower and hasNumber and hasSymbol):
      print("The password is invalid!! Please add upper case and lower case")
    elif(not hasUpper and hasLower and not hasNumber and hasSymbol):
      print("The password is invalid!! Please add upper case and number")
    elif(not hasUpper and hasLower and hasNumber and not hasSymbol):
      print("The password is invalid!! Please add upper case and symbol")
    elif(not hasUpper and not hasLower and not hasNumber and hasSymbol):
      print("The password is invalid!! Please add upper case and lower case and number")
    elif(not hasUpper and not hasLower and hasNumber and not hasSymbol):
      print("The password is invalid!! Please add upper case and lower case and symbol")
    elif(not hasUpper and hasLower and not hasNumber and not hasSymbol):
      print("The password is invalid!! Please add upper case and number and symbol")

    elif( hasUpper and not hasLower and hasNumber and hasSymbol):
      print("The password is invalid!! Please add lower case")
    elif( hasUpper and not hasLower and not hasNumber and hasSymbol):
      print("The password is invalid!! Please add lower case and number")
    elif( hasUpper and not hasLower and hasNumber and not hasSymbol):
      print("The password is invalid!! Please add lower case and symbol")
    elif( hasUpper and not hasLower and not hasNumber and not hasSymbol):
      print("The password is invalid!! Please add lower case and number and symbol")

    elif( hasUpper and hasLower and not hasNumber and hasSymbol):
      print("The password is invalid!! Please add number")
    elif( hasUpper and hasLower and not hasNumber and not hasSymbol):
      print("The password is invalid!! Please add number and symbol")

    elif( hasUpper and hasLower and hasNumber and not hasSymbol):
      print("The password is invalid!! Please add symbol")
  else:
